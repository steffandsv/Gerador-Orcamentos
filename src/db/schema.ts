...
export const orcamentos = mysqlTable('orcamentos', {
  ...
  empresa1_id: int('empresa1_id').references(() => empresas.id),
  empresa2_id: int('empresa2_id').references(() => empresas.id),
  empresa3_id: int('empresa3_id').references(() => empresas.id),
  variacao_maxima: decimal('variacao_maxima', { precision: 5, scale: 2 }),
